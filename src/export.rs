...
pub fn get_correlation_fn(index: usize, incomplete_path: &str) -> Result<Vec<f64>, Box<dyn Error>> {
    let path: &str = &(incomplete_path.to_owned() + &"correlation_" + &index.to_string() + &".csv");
