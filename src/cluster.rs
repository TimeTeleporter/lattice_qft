    ...
    [(); D * 2_usize]:,
{
    ...
    let data: MarkovChain = MarkovChain::new(sim_obs_ary);

    let results: SimResult = SimResult::new(temp, burnin, iterations, observable);

    println!("ClusterSim {:?}", results);
